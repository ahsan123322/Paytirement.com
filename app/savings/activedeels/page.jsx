...
const savings = () => {
  ...
  return (
    <>
    <div className='mx-12'>
      <PaymentHero addPadding={true} style={margintop} heading={'Active Deals'}  pargraph={"Inclusive of your daily spendings, paytirement scans thousands of deals across various retailers and service providers.The platform aggregates these deals in one place, so you don't have to spend time searching multiple platforms. This ensures you never miss out on the best saving offers available. "} 
      src={activedeels} />
